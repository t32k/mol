---
layout: post
title: document.writeでSCRIPTを書き出すなやで！
categories:
- javascript
- performance
- translate
...
meta:
  ...
  pvc_views: '18251'
---
<cite>原文：<a href="http://www.stevesouders.com/blog/2012/04/10/dont-docwrite-scripts/">Don’t docwrite scripts | High Performance Web Sites</a>
投稿日：2012-4-10 by STEVE SOUDERS</cite>
...
<!--more-->
<pre><code>document.write('&lt;script src="' + src + '" type="text/javascript"&gt;&lt;\/script&gt;'):</code></pre>
...
<pre><code>var sNew = document.createElement("script");
sNew.async = true;
